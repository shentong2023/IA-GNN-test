...
def main():
    ...
    train_data = pickle.load(open('/home/huashanshan/IA-GNN/datasets/diginetica/preprocessed/train.txt', 'rb'))
    test_data = pickle.load(open('/home/huashanshan/IA-GNN/datasets/diginetica/preprocessed/test.txt', 'rb'))
