...
parser.add_argument('--dataset', default='tmall', help='dataset name:diginetica/tmall/retailrocket')
...
def main():
    ...
    train_data = pickle.load(open('/home/huashanshan/IA-GNN/datasets/tmall/preprocessed/train.txt', 'rb'))
    test_data = pickle.load(open('/home/huashanshan/IA-GNN/datasets/tmall/preprocessed/test.txt', 'rb'))
