...
def main():
    ...
    train_data = pickle.load(open('/home/huashanshan/IA-GNN/datasets/retailrocket/preprocessed_slice2/train.txt', 'rb'))
    test_data = pickle.load(open('/home/huashanshan/IA-GNN/datasets/retailrocket/preprocessed_slice2/test.txt', 'rb'))
