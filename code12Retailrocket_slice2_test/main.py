...
def main():
    ...
    train_data = pickle.load(open('/home/huashanshan/IA-GNN/datasets/retailrocket/preprocessed_slice2_test/train.txt', 'rb'))
    test_data = pickle.load(open('/home/huashanshan/IA-GNN/datasets/retailrocket/preprocessed_slice2_test/test.txt', 'rb'))
    ...
    if opt.dataset == 'diginetica':
        ...
        n_node = 28906  # 实际node个(不加补充的node)
