...
def main():
    ...
    train_data = pickle.load(open('/home/huashanshan/IA-GNN/datasets/retailrocket/preprocessed_slice3/train.txt', 'rb'))
    test_data = pickle.load(open('/home/huashanshan/IA-GNN/datasets/retailrocket/preprocessed_slice3/test.txt', 'rb'))
    ...
    if opt.dataset == 'diginetica':
        ...
        n_node = 33503  # 实际node个(不加补充的node)
