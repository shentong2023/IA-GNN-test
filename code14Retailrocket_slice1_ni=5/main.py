...
parser.add_argument('--dataset', default='retailrocket', help='dataset name:diginetica/tmall/retailrocket')
...
parser.add_argument('--n_intentions', type=int, default=5, help='number of intentions')
...
def main():
    ...
    train_data = pickle.load(open('/home/huashanshan/IA-GNN/datasets/retailrocket/preprocessed_slice1/train.txt', 'rb'))
    test_data = pickle.load(open('/home/huashanshan/IA-GNN/datasets/retailrocket/preprocessed_slice1/test.txt', 'rb'))
    ...
    if opt.dataset == 'diginetica':
        ...
        n_node = 35637  # 实际node个(不加补充的node)
