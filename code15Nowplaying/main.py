...
def main():
    ...
    train_data = pickle.load(open('/home/huashanshan/IA-GNN/datasets/Nowplaying/train.txt', 'rb'))
    test_data = pickle.load(open('/home/huashanshan/IA-GNN/datasets/Nowplaying/test.txt', 'rb'))
    ...
    if opt.dataset == 'diginetica':
        ...
        n_node = 60416  # 实际node个(不加补充的node)
