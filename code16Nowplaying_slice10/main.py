...
parser.add_argument('--dataset', default='nowplaying', help='dataset name:diginetica/tmall/retailrocket')
...
def main():
    ...
    train_data = pickle.load(open('/home/huashanshan/IA-GNN/datasets/nowplaying/preprocessed_slice20/train.txt', 'rb'))
    test_data = pickle.load(open('/home/huashanshan/IA-GNN/datasets/nowplaying/preprocessed_slice20/test.txt', 'rb'))
