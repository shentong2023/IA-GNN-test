...
def main():
    ...
    train_data = pickle.load(open('/home/huashanshan/IA-GNN/datasets/yoochoose_buys/train.txt', 'rb'))
    test_data = pickle.load(open('/home/huashanshan/IA-GNN/datasets/yoochoose_buys/test.txt', 'rb'))
